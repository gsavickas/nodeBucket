...
SigninComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: SigninComponent, selectors: [["app-signin"]], decls: 12, vars: 4, consts: [["fxLayout", "column"], ["fxFlex", "", 4, "ngIf"], ["fxFlex", ""], [3, "formGroup", "ngSubmit"], ["matInput", "", "placeholder", "Employee ID", 3, "formControl"], ["type", "submit", "fxFlex", "", "mat-raised-button", "", "colo", "primary", 3, "disabled"]], template: function SigninComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("ngSubmit", function SigninComponent_Template_form_ngSubmit_5_listener() { ctx.login(); return ctx.form.reset(); });
